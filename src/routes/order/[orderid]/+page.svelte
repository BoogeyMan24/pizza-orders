...
<section class="p-12 w-[95%] md:w-[40rem] mx-auto">
	...
	<div class="flex justify-between my-2">
		<h3 class="monofont">Pizza Date: {date.getDate()} {convertNumToStringMonth(date.getMonth() + 1)}, {date.getFullYear()}</h3>
		<!-- <h3 class="monofont">{date.getHours()}:{date.getMinutes() < 10 ? "0" + date.getMinutes() : date.getMinutes()}</h3> -->
	</div>
